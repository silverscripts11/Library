	...
	if game.CoreGui:FindFirstChild('QuarUI') then
	    game.CoreGui:FindFirstChild('QuarUI'):Destroy()
	    destroyed = true
	end
	...
	local QuarUI = Instance.new("ScreenGui")
	QuarUI.Name = "QuarUI"
	protect_gui(QuarUI)
	...
	function library:Keybind(key)
	    ...
	    keybindConnection = UserInputService.InputBegan:Connect(function(input, gp)
	        if not gp and input.KeyCode == Enum.KeyCode[key] then
	            QuarUI.Enabled = not QuarUI.Enabled
	        end
	    end)
	end
	...
	function library:Window(name) 
	    ...
	    UiWindow.BackgroundColor3 = Color3.fromRGB(67, 67, 68)
	    UiWindow.BorderColor3 = Color3.fromRGB(67, 67, 68)
	    ...
	    Header.BorderColor3 = Color3.fromRGB(75, 75, 75)
